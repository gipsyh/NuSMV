...
static inline void trace_reset_length(const Trace_ptr self);

static inline void trace_inc_length(const Trace_ptr self);

static inline void trace_set_language(Trace_ptr self, SymbTable_ptr st,
...
static inline void trace_var_frame_set_state_base(const TraceVarFrame_ptr frame,
						  node_ptr *base);
static inline node_ptr *
trace_var_frame_get_input_base(const TraceVarFrame_ptr frame);

static inline void trace_var_frame_set_input_base(const TraceVarFrame_ptr frame,
						  node_ptr *base);

static inline node_ptr *
trace_define_frame_get_state_base(const TraceDefineFrame_ptr frame);

static inline void trace_define_frame_set_state_base(TraceDefineFrame_ptr frame,
						     node_ptr *base);

static inline node_ptr *
trace_define_frame_get_input_base(const TraceDefineFrame_ptr frame);

static inline void trace_define_frame_set_input_base(TraceDefineFrame_ptr frame,
						     node_ptr *base);
...
static inline void trace_define_frame_set_next_base(TraceDefineFrame_ptr frame,
						    node_ptr *base);
...
static inline void
trace_define_frame_set_state_input_next_base(TraceDefineFrame_ptr frame,
					     node_ptr *base);

static inline unsigned trace_get_n_state_vars(const Trace_ptr self);

static inline unsigned trace_get_n_frozen_vars(const Trace_ptr self);

static inline unsigned trace_get_n_input_vars(const Trace_ptr self);

static inline unsigned trace_get_n_state_defines(const Trace_ptr self);

static inline unsigned trace_get_n_input_defines(const Trace_ptr self);

static inline unsigned trace_get_n_state_input_defines(const Trace_ptr self);

static inline unsigned trace_get_n_next_defines(const Trace_ptr self);

static inline unsigned trace_get_n_state_next_defines(const Trace_ptr self);

static inline unsigned trace_get_n_input_next_defines(const Trace_ptr self);

static inline void trace_set_first_frame(Trace_ptr self,
					 TraceVarFrame_ptr var_frame);

static inline void trace_set_last_frame(Trace_ptr self,
					TraceVarFrame_ptr var_frame);

static inline TraceFrozenFrame_ptr trace_get_frozen_frame(Trace_ptr self);

static inline void trace_set_frozen_frame(Trace_ptr self,
					  TraceFrozenFrame_ptr frozen_frame);

/* frame management */
static inline TraceFrozenFrame_ptr trace_frozen_frame_create(Trace_ptr self);

static inline void
trace_frozen_frame_destroy(TraceFrozenFrame_ptr frozen_frame);

static inline TraceVarFrame_ptr trace_var_frame_create(Trace_ptr self);

static inline void trace_var_frame_destroy(TraceVarFrame_ptr frame);

static inline TraceDefineFrame_ptr trace_define_frame_create(Trace_ptr self);

static inline void trace_define_frame_destroy(TraceDefineFrame_ptr def_frame);

static inline void trace_var_frame_set_prev(TraceVarFrame_ptr frame,
					    TraceVarFrame_ptr prev);

static inline TraceVarFrame_ptr
trace_var_frame_get_prev(TraceVarFrame_ptr frame);

static inline void trace_var_frame_set_next(TraceVarFrame_ptr frame,
					    TraceVarFrame_ptr next);
...
static inline node_ptr *trace_iter_get_section_base(Trace_ptr trace,
						    TraceIter iter,
						    TraceSection sect_type,
						    boolean create);

/* lookup management */
static inline void trace_insert_lookup_info(Trace_ptr trace, node_ptr symb_name,
					    TraceSection section,
					    unsigned offset);
static inline void trace_setup_lookup_section(Trace_ptr self,
					      TraceSection section);
static inline void trace_init_lookup_data(Trace_ptr self);

static inline void trace_copy_lookup_data(Trace_ptr dst, Trace_ptr src);

static inline void trace_setup_lookup_cache(Trace_ptr self);

static inline void trace_dispose_lookup_cache(Trace_ptr self);

static inline void trace_print_alloc_stats(Trace_ptr self);
...
static inline void trace_var_frame_set_next_frame(TraceVarFrame_ptr var_frame,
						  TraceVarFrame_ptr next_frame);

static inline void trace_var_frame_set_prev_frame(TraceVarFrame_ptr var_frame,
						  TraceVarFrame_ptr prev_frame);

/* internal getters/setters */
static inline void trace_inc_n_section_symbols(Trace_ptr self,
					       TraceSection section);

static inline unsigned trace_get_n_section_symbols(const Trace_ptr self,
						   TraceSection section);

static inline node_ptr *trace_get_section_symbols(Trace_ptr self,
						  TraceSection section);
...
static inline void trace_init(Trace_ptr self);

static inline void trace_frozen_frame_init(TraceFrozenFrame_ptr self);

static inline void trace_var_frame_init(TraceVarFrame_ptr self);

static inline void trace_define_frame_init(TraceDefineFrame_ptr self);

static inline node_ptr *trace_setup_section_storage(Trace_ptr trace,
						    unsigned n_symbs);

static inline void trace_copy_section_storage(node_ptr *dest, node_ptr *src,
					      unsigned n_symbs);
static inline int trace_compare_section_storage(node_ptr *dest, node_ptr *src,
						unsigned n_symbs);
		       ...
		       boolean allow_bits)
{
	...
	{ /* phase 1: initial frame setup */
		...
		trace_var_frame_set_fwd_define_frame(initial_frame,
						     define_frame);
...
void trace_destroy(Trace_ptr self)
{
	...
	{
		TraceSection idx;
		for (idx = TRACE_SECTION_INVALID; idx < TRACE_SECTION_END;
		     ++idx) {
	...
	/* phase 4: copy var and define frame data until given iterator */
	{
		...
		while (TRACE_END_ITER != src_iter) {
			...
			for (section = TRACE_SECTION_STATE_VAR;
				...
				src_base = trace_iter_get_section_base(
					self, src_iter, section, false);

				if ((node_ptr *)(NULL) != src_base) {
					trace_copy_section_storage(
						trace_iter_get_section_base(
							res, dst_iter, section,
							true),
						src_base,
						trace_get_n_section_symbols(
							self, section));
				}
			}
			if (src_iter == until_here)
				break; /* up to (included) until_here */
...
static inline boolean trace_cmp_language(Trace_ptr self, Trace_ptr other)
{
	NodeList_ptr l0 = trace_get_symbols(self);
	NodeList_ptr l1 = trace_get_symbols(other);
	ListIter_ptr i;

	if (NodeList_get_length(l0) != NodeList_get_length(l1)) {
		return false;
	}
	...
	{
		if (!NodeList_belongs_to(l1, NodeList_get_elem_at(l0, i))) {
			return false;
		}
	}
...
Trace_ptr trace_concat(Trace_ptr self, Trace_ptr *other)
{
	...
	nusmv_assert((Trace_ptr *)(NULL) !=
		     other); /* preventing nasty usages */
	...
	if (false == trace_cmp_language(self, *other)) {
		ErrorMgr_internal_error(
			errmgr,
			"%s:%d:%s: Trace languages mismatch detected. "
			"[L(t1) != L(t2)]",
	...
	if (trace_is_registered(*other)) {
		ErrorMgr_internal_error(
			errmgr,
			"%s:%d:%s: Cannot concatenate a registered trace",
			__FILE__, __LINE__, __func__);
	}
	...
	/* 2. merge frozen frames from both traces */
	{
		...
		{
			node_ptr v0 =
				trace_step_get_value(self, TRACE_END_ITER, fv);
			node_ptr v1 = trace_step_get_value(*other,
							   TRACE_END_ITER, fv);
			...
			trace_step_put_value(self, TRACE_END_ITER, fv,
					     (Nil != v0) ? v0 : v1);
		}
	} /* merge frozens */
	...
	/* 3. merge frontier state frames from both traces */
	{
		...
		TRACE_SYMBOLS_FOREACH(self, TRACE_ITER_F_VARS, i0, fv)
		{
			...
			trace_step_put_value(self, lhs, fv,
					     (Nil != v0) ? v0 : v1);
		}
	...
	/* phase 4: consume "other" trace, link its data to self */
	{
		...
		TraceIter rhs_link =
			trace_iter_get_next(trace_first_iter(*other));
		...
		if (TRACE_END_ITER != rhs_link) {
			...
			trace_set_last_frame(self,
					     TRACE_VAR_FRAME(rhs_last_iter));
			self->length += (*other)->length;

			trace_var_frame_set_prev(rhs_link,
						 TRACE_VAR_FRAME(lhs_link));
			trace_var_frame_set_bwd_define_frame(
				rhs_link, trace_var_frame_get_fwd_define_frame(
						  TRACE_VAR_FRAME(lhs_link)));
		}

		/* dispose first var frame for other */
		trace_var_frame_destroy(
			TRACE_VAR_FRAME(trace_first_iter(*other)));
...
TraceStepIter trace_step_iter(const Trace_ptr trace, const TraceIter step,
			      TraceIteratorType iter_type)
{
	...
	res.section = TRACE_SECTION_FROZEN_VAR;
	do {
...
TraceSymbolsIter trace_symbols_iter(const Trace_ptr trace,
				    TraceIteratorType iter_type)
{
...
boolean trace_step_iter_fetch(TraceStepIter *iter, node_ptr *symb_name,
			      node_ptr *symb_value)
{
	node_ptr *base;
	node_ptr value = Nil;
	...
	while (true) {
		/* end of iteration? */
		if (TRACE_SECTION_END == iter->section)
			return false;
       ...
       sentinel nodes */
		...
		if (FAILURE != node_get_type(value))
			break;
	...
	(*symb_value) = value;
	(*symb_name) = trace_symbol_bwd_lookup(iter->trace, iter->section,
					       iter->cursor - 1);
...
/* DANGER: hazardous area */
boolean trace_symbols_iter_fetch(TraceSymbolsIter *iter, node_ptr *symb_name)
{
	node_ptr *base;
	node_ptr *addr;
				      ...
				      boolean allow_bits)
{
	...
	if (NODE_LIST(NULL) != symbols) {
		NODE_LIST_FOREACH(symbols, iter)
		{
			...
			{
				SymbType_ptr sym_type =
					TypeChecker_get_expression_type(tc, sym,
									Nil);
			...
			{ /* only valid symbols are allowed into traces */
				SymbCategory cat =
					SymbTable_get_symbol_category(st, sym);
				const MasterPrinter_ptr wffprint =
					MASTER_PRINTER(NuSMVEnv_get_value(
						env, ENV_WFF_PRINTER));
				...
				if (SYMBOL_INVALID == cat) {
					ErrorMgr_internal_error(
						errmgr,
						"%s:%d:%s: Invalid symbol detected (%s)",
						__FILE__, __LINE__, __func__,
						sprint_node(wffprint, sym));
				}
			}

			{ /* skip variables in layers registered in ARTIFACTS_LAYERS_CLASS
           (e.g. LTL tableau) */
				const char *layer_name = SymbLayer_get_name(
					SymbTable_symbol_get_layer(st, sym));

				nusmv_assert(NIL(char) != layer_name);

				if (SymbTable_layer_class_exists(
					    st, ARTIFACTS_LAYERS_CLASS) &&
			...
			if (opt_verbose_level_ge(opts, 6)) {
				...
				Logger_log(
					logger,
					"%s:%d:%s: adding symbol '%s' to language\n",
					__FILE__, __LINE__, __func__, repr);
				FREE(repr);
			}
	...
	if (opt_verbose_level_ge(opts, 4) &&
		...
		StreamMgr_print_error(streams,
				      "Warning: Trace has empty language.\n");
	}
...
SymbTable_ptr trace_get_symb_table(const Trace_ptr self)
{
...
void trace_set_type(const Trace_ptr self, TraceType type)
{
	nusmv_assert((TRACE_TYPE_UNSPECIFIED <= type) &&
		     (type < TRACE_TYPE_END));
	self->type = type;
}
...
/* frames management */
static inline TraceFrozenFrame_ptr trace_get_frozen_frame(const Trace_ptr self)
{
...
static TraceVarFrame_ptr trace_var_frame_create(Trace_ptr self)
{
	TraceVarFrame_ptr res = ALLOC(TraceVarFrame, 1);
	TRACE_VAR_FRAME_CHECK_INSTANCE(res);
	trace_var_frame_init(res);

	trace_var_frame_set_state_base(
		res, trace_setup_section_storage(self,
						 trace_get_n_state_vars(self)));

	trace_var_frame_set_input_base(
		res, trace_setup_section_storage(self,
...
/*!
  ...
  \todo Missing description
*/
static inline void trace_var_frame_destroy(TraceVarFrame_ptr var_frame)
{
...
TraceDefineFrame_ptr trace_define_frame_create(Trace_ptr self)
{
...
static inline void trace_define_frame_destroy(TraceDefineFrame_ptr def_frame)
{
	...
	if ((node_ptr *)(NULL) != def_frame->s_values) {
		FREE(def_frame->s_values);
	}
	if ((node_ptr *)(NULL) != def_frame->i_values) {
		FREE(def_frame->i_values);
	}
	if ((node_ptr *)(NULL) != def_frame->si_values) {
		FREE(def_frame->si_values);
	}
	if ((node_ptr *)(NULL) != def_frame->n_values) {
		FREE(def_frame->n_values);
	}
	if ((node_ptr *)(NULL) != def_frame->sn_values) {
		FREE(def_frame->sn_values);
	}
	if ((node_ptr *)(NULL) != def_frame->in_values) {
		FREE(def_frame->in_values);
	}
	if ((node_ptr *)(NULL) != def_frame->sin_values) {
		FREE(def_frame->sin_values);
	}

	FREE(def_frame);
}

static TraceFrozenFrame_ptr trace_frozen_frame_create(Trace_ptr self)
{
	TraceFrozenFrame_ptr res = ALLOC(TraceFrozenFrame, 1);
	TRACE_FROZEN_FRAME_CHECK_INSTANCE(res);
	trace_frozen_frame_init(res);

	res->frozen_values = trace_setup_section_storage(
		self, trace_get_n_frozen_vars(self));

	return res;
}

static void trace_frozen_frame_destroy(TraceFrozenFrame_ptr frozen_frame)
{
...
SymbCategory trace_symbol_get_category(Trace_ptr self, node_ptr symb)
{
	...
	if (!hit) {
		ErrorMgr_internal_error(errmgr,
					"%s:%d:%s: Symbol not found (%s)",
					__FILE__, __LINE__, __func__,
					sprint_node(wffprint, symb));
	}
...
boolean trace_step_is_loopback(Trace_ptr self, const TraceIter step)
{
	/* loopback has no semantics in simulation */
	if (TRACE_TYPE_SIMULATION == trace_get_type(self))
		return false;

	/* 0-length loopbacks are not valid  */
	if (step == trace_last_iter(self))
		return false;
...
boolean trace_step_test_loopback(Trace_ptr self, const TraceIter step)
{
	...
	last_base = trace_var_frame_get_state_base(
		TRACE_VAR_FRAME(trace_last_iter(self)));

	/* perform low level full comparison, only state vars are relevant
     w.r.t. loopback calculation */
	return (0 ==
		trace_compare_section_storage(step_base, last_base, nvars));
...
void trace_step_force_loopback(const Trace_ptr self, TraceIter step)
{
	...
	if (!trace_step_test_loopback(self, step)) {
		...
		StreamMgr_print_error(streams,
				      "WARNING: state not a loopback state\n");
	}
...
boolean trace_equals(const Trace_ptr self, const Trace_ptr other)
{
	...
	if (TRACE(NULL) == self || TRACE(NULL) == other)
		return false;

	if (trace_get_length(self) != trace_get_length(other))
		return false;

	if (!trace_cmp_language(self, other))
		return false;

	/* test frozenvars for equality */
	if (0 !=
	    trace_compare_section_storage(
	...
	while (TRACE_END_ITER != self_step) {
		if (0 != trace_compare_section_storage(
				 trace_var_frame_get_input_base(
					 TRACE_VAR_FRAME(self_step)),
				 trace_var_frame_get_input_base(
					 TRACE_VAR_FRAME(other_step)),
				 trace_get_n_input_vars(self))) {
			return false;
		}

		if (0 != trace_compare_section_storage(
				 trace_var_frame_get_state_base(
					 TRACE_VAR_FRAME(self_step)),
				 trace_var_frame_get_state_base(
					 TRACE_VAR_FRAME(other_step)),
				 trace_get_n_state_vars(self))) {
			     ...
			     node_ptr value)
{
	...
	if (trace_symbol_fwd_lookup(self, symb, &section, &offset)) {
		...
		CHECK(section >= TRACE_SECTION_STATE_DEFINE ||
		      trace_is_thawed(self));
		...
		addr = base + offset;
		CHECK(Nil == *addr ||
		      *addr == value); /* value is blank or matching */
		...
		if (!res) { /* type error */
			StreamMgr_print_error(
				streams, "--> suspicious assignment was: %s\n",
				sprint_node(UNION == node_get_type(value) ?
						    ExprMgr_setin(exprs, symb,
								  value,
								  symb_table) :
						    ExprMgr_equal(exprs, symb,
								  value,
								  symb_table)));
		}
#endif
...
/* returns a valid node_ptr iff a symbol in in trace language is
   ...
   error */
node_ptr trace_step_get_value(Trace_ptr self, TraceIter step, node_ptr symb)
{
	TraceSection section;
	unsigned offset;
...

	{
		...
		ErrorMgr_internal_error(
			errmgr, "%s:%d:%s:  symbol not in language (%s).",
			__FILE__, __LINE__, __func__,
			sprint_node(wffprint, symb));
	}
	return Nil;
...
static inline node_ptr *trace_setup_section_storage(Trace_ptr self,
						    unsigned n_symbs)
{
...
const char *trace_get_layer_from_symb(const Trace_ptr trace,
				      const node_ptr symb)
{
	CHECK(Nil != symb);
...
static inline void trace_init_lookup_data(Trace_ptr self)
{
	...
	NODE_LIST_FOREACH(symbols, iter)
	{
		...
		SymbCategory category =
			SymbTable_get_symbol_category(st, symb_name);

		if (category != SYMBOL_FUNCTION) {
			TraceSection section =
				trace_category_to_section(category);
	...
	NODE_LIST_FOREACH(symbols, iter)
	{
		...
		if (category != SYMBOL_FUNCTION) {
			...
			trace_insert_lookup_info(self, symb_name, section,
						 counters[section]++);
		}
	}
...
/*!
  ...
  \todo Missing description
*/
static inline void trace_copy_lookup_data(Trace_ptr self, Trace_ptr src)
{
	SymbTable_ptr st = trace_get_symb_table(self);
	...
	memcpy(self->n_buckets, src->n_buckets,
	       TRACE_SECTION_END * sizeof(unsigned));
...
{
	const NuSMVEnv_ptr env =
		EnvObject_get_environment(ENV_OBJECT(trace->st));
	const ErrorMgr_ptr errmgr =
		ERROR_MGR(NuSMVEnv_get_value(env, ENV_ERROR_MANAGER));
	...
	case TRACE_SECTION_FROZEN_VAR:
		CHECK((node_ptr *)NULL !=
		      trace_frozen_frame_get_base(
			      trace_get_frozen_frame(trace)));
		return trace_frozen_frame_get_base(
			trace_get_frozen_frame(trace));
	...
	case TRACE_SECTION_STATE_DEFINE: {
		...
		if ((node_ptr *)(NULL) == res && create) {
			res = trace_setup_section_storage(
				trace, trace_get_n_state_defines(trace));
	...
	case TRACE_SECTION_INPUT_DEFINE: {
		...
		if ((node_ptr *)(NULL) == res && create) {
			res = trace_setup_section_storage(
				trace, trace_get_n_input_defines(trace));
	...
	case TRACE_SECTION_STATE_INPUT_DEFINE: {
		...
		if ((node_ptr *)(NULL) == res && create) {
			res = trace_setup_section_storage(
				trace, trace_get_n_state_input_defines(trace));
	...
	case TRACE_SECTION_NEXT_DEFINE: {
		...
		if ((node_ptr *)(NULL) == res && create) {
			res = trace_setup_section_storage(
				trace, trace_get_n_next_defines(trace));
	...
	case TRACE_SECTION_STATE_NEXT_DEFINE: {
		...
		if ((node_ptr *)(NULL) == res && create) {
			res = trace_setup_section_storage(
				trace, trace_get_n_state_next_defines(trace));
	...
	case TRACE_SECTION_INPUT_NEXT_DEFINE: {
		...
		if ((node_ptr *)(NULL) == res && create) {
			res = trace_setup_section_storage(
				trace, trace_get_n_input_next_defines(trace));
	...
	case TRACE_SECTION_STATE_INPUT_NEXT_DEFINE: {
		...
		if ((node_ptr *)(NULL) == res && create) {
			...
			trace_define_frame_set_state_input_next_base(dframe,
								     res);
		}
...
static inline void trace_setup_lookup_cache(Trace_ptr self)
{
	...
	memset(self->buckets, 0,
	       (TRACE_SECTION_END - TRACE_SECTION_INVALID) *
		       sizeof(node_ptr *));
					      ...
					      TraceSection section)
{
	...
	if (0 < sect_size) {
		self->buckets[section] =
			trace_setup_section_storage(self, sect_size);
	}
}
...
SymbCategory trace_section_to_category(const TraceSection section)
{
	switch (section) {
	case TRACE_SECTION_FROZEN_VAR:
		return SYMBOL_FROZEN_VAR;
	case TRACE_SECTION_STATE_VAR:
		return SYMBOL_STATE_VAR;
	case TRACE_SECTION_INPUT_VAR:
		return SYMBOL_INPUT_VAR;
	case TRACE_SECTION_STATE_DEFINE:
		return SYMBOL_STATE_DEFINE;
	case TRACE_SECTION_INPUT_DEFINE:
		return SYMBOL_INPUT_DEFINE;
	case TRACE_SECTION_STATE_INPUT_DEFINE:
		return SYMBOL_STATE_INPUT_DEFINE;
	case TRACE_SECTION_NEXT_DEFINE:
		return SYMBOL_NEXT_DEFINE;
	case TRACE_SECTION_STATE_NEXT_DEFINE:
		return SYMBOL_NEXT_DEFINE;
	case TRACE_SECTION_INPUT_NEXT_DEFINE:
		return SYMBOL_INPUT_NEXT_DEFINE;
	case TRACE_SECTION_STATE_INPUT_NEXT_DEFINE:
		return SYMBOL_STATE_INPUT_NEXT_DEFINE;
	default:
...
TraceSection trace_category_to_section(const SymbCategory category)
{
	...
	case SYMBOL_FROZEN_VAR:
		return TRACE_SECTION_FROZEN_VAR;
	case SYMBOL_STATE_VAR:
		return TRACE_SECTION_STATE_VAR;
	case SYMBOL_INPUT_VAR:
		return TRACE_SECTION_INPUT_VAR;
	case SYMBOL_CONSTANT:
	case SYMBOL_STATE_DEFINE:
		return TRACE_SECTION_STATE_DEFINE;
	case SYMBOL_INPUT_DEFINE:
		return TRACE_SECTION_INPUT_DEFINE;
	case SYMBOL_STATE_INPUT_DEFINE:
		return TRACE_SECTION_STATE_INPUT_DEFINE;
	case SYMBOL_NEXT_DEFINE:
		return TRACE_SECTION_NEXT_DEFINE;
	case SYMBOL_STATE_NEXT_DEFINE:
		return TRACE_SECTION_STATE_NEXT_DEFINE;
	case SYMBOL_INPUT_NEXT_DEFINE:
		return TRACE_SECTION_INPUT_NEXT_DEFINE;
	case SYMBOL_STATE_INPUT_NEXT_DEFINE:
		return TRACE_SECTION_STATE_INPUT_NEXT_DEFINE;
	default:
		error_unreachable_code();
	}
...
const char *trace_symb_category_to_string(const SymbCategory category)
{
	...
	case SYMBOL_INPUT_DEFINE:
		return "input define";
	case SYMBOL_STATE_INPUT_DEFINE:
		return "state-input define";
	case SYMBOL_NEXT_DEFINE:
		return "next define";
	case SYMBOL_STATE_NEXT_DEFINE:
		return "state-next define";
	case SYMBOL_INPUT_NEXT_DEFINE:
		return "input-next define";
	case SYMBOL_STATE_INPUT_NEXT_DEFINE:
		return "state-input-next define";
	default:
		error_unreachable_code();
	}
...
static inline unsigned trace_get_n_section_symbols(const Trace_ptr self,
						   TraceSection section)
{
	nusmv_assert(TRACE_SECTION_INVALID < section &&
		     section <= TRACE_SECTION_END);
			       ...
			       FILE *report_stream)
{
	...
	TRACE_FOREACH(self, step)
	{
		...
		NODE_LIST_FOREACH(vars, list_iter)
		{
			...
			if (SYMBOL_FUNCTION !=
			    SymbTable_get_symbol_category(self->st, var)) {
				if (trace_symbol_fwd_lookup(self, var, &section,
							    &dummy)) {
					nusmv_assert(TRACE_SECTION_FROZEN_VAR ==
							     section ||
