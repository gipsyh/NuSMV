...
#define DEFINE_VECTOR__impl_(qual, type, name, prefix)                         \
	...
	{                                                                      \
		...
		memcpy(v1->data_ + v1->size_, v2->data_,                       \
		       sizeof(type) * v2->size_);                              \
		v1->size_ += v2->size_;                                        \
	}                                                                      \
                                                                               \
	qual void prefix##_resize(name v, size_t newsz)                        \
	...
	{                                                                      \
		...
		v2->data_ = tmp2;                                              \
                                                                               ...
                                                                               \
	static void prefix##_sort_impl(type *arr, size_t size,                 \
				       int (*cmp)(type a, type b, void *p),    \
				       void *p)                                \
	{                                                                      \
