...
void Tuple5_freeze(Tuple5_ptr self) { self->frozen = true; }

boolean Tuple5_is_freezed(const Tuple5_ptr self) { return self->frozen; }

void *Tuple5_get_first(const Tuple5_ptr self) { return self->first; }

void *Tuple5_get_second(const Tuple5_ptr self) { return self->second; }

void *Tuple5_get_third(const Tuple5_ptr self) { return self->third; }

void *Tuple5_get_forth(const Tuple5_ptr self) { return self->forth; }

void *Tuple5_get_fifth(const Tuple5_ptr self) { return self->fifth; }
...
unsigned long Tuple5_hash(const Tuple5_ptr self, int size) {
  size_t ret = ((((size_t)self->first) + 31) + (((size_t)self->second) << 1) +
                (((size_t)self->third) << 2) + (((size_t)self->forth) << 3) +
                (((size_t)self->fifth) << 4));
...
/*!
  ...
  \sa Tuple5_destroy
*/
static void tuple5_deinit(Tuple5_ptr self) { /* members deinitialization */ }
