...
WordNumberValue_intern
WordNumber_evaluate_unsigned_extend(WordNumberValue_intern v, int numberOfTimes)
{
	WordNumberValue_intern value;
	int new_width;
						       ...
						       int numberOfBits)
{
	...
	for (i = 0; i < numberOfBits; ++i) {
		...
		raw_value = WordNumber_create_WordNumberValue_intern(new_v,
								     v.width);
	}
						...
						WordNumberValue_intern v2)
{
	...
	if (!msb_v1 && !msb_v2) {
		...
		WordNumberValue_intern neg_v1 =
			WordNumber_evaluate_unary_minus(v1);
		WordNumberValue_intern umod =
			WordNumber_evaluate_urem(neg_v1, v2);
		rvalue = WordNumber_evaluate_unary_minus(umod);

		WNV_free_WordNumberValue_intern(&neg_v1);
		WNV_free_WordNumberValue_intern(&umod);
	} else if (!msb_v1 && msb_v2) {
		WordNumberValue_intern neg_v2 =
			WordNumber_evaluate_unary_minus(v2);
						...
						WordNumberValue_intern v2)
{
	...
	if (!bit1 && !bit2) {
		...
		WordNumberValue_intern neg_v1 =
			WordNumber_evaluate_unary_minus(v1);
		WordNumberValue_intern dif =
			WordNumber_evaluate_udiv(neg_v1, v2);
		...
		WordNumberValue_intern neg_v2 =
			WordNumber_evaluate_unary_minus(v2);
		WordNumberValue_intern dif =
			WordNumber_evaluate_udiv(v1, neg_v2);
		rvalue = WordNumber_evaluate_unary_minus(dif);
