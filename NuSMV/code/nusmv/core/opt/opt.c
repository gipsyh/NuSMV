...
void set_output_flatten_model_file(OptsHandler_ptr opt, char *str) {
  boolean res =
      OptsHandler_set_option_value(opt, OUTPUT_FLATTEN_MODEL_FILE, str);
  nusmv_assert(res);
}
...
void set_output_boolean_model_file(OptsHandler_ptr opt, char *str) {
  boolean res =
      OptsHandler_set_option_value(opt, OUTPUT_BOOLEAN_MODEL_FILE, str);
  nusmv_assert(res);
}
...
void set_backward_comp(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, BACKWARD_COMPATIBILITY, true);
  nusmv_assert(res);
}

void unset_backward_comp(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, BACKWARD_COMPATIBILITY, false);
  nusmv_assert(res);
}
...
void set_type_checking_warning_on(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, TYPE_CHECKING_WARNING_ON, true);
  nusmv_assert(res);
}

void unset_type_checking_warning_on(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, TYPE_CHECKING_WARNING_ON, false);
  nusmv_assert(res);
}
...
void set_ltl_tableau_forward_search(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, LTL_TABLEAU_FORWARD_SEARCH, true);
  nusmv_assert(res);
}
void unset_ltl_tableau_forward_search(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, LTL_TABLEAU_FORWARD_SEARCH, false);
  nusmv_assert(res);
}
...
void set_enable_sexp2bdd_caching(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, ENABLE_SEXP2BDD_CACHING, true);
  nusmv_assert(res);
}
void unset_enable_sexp2bdd_caching(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, ENABLE_SEXP2BDD_CACHING, false);
  nusmv_assert(res);
}
...
void set_conj_part_threshold(OptsHandler_ptr opt, int threshold) {
  boolean res =
      OptsHandler_set_int_option_value(opt, CONJ_PART_THRESHOLD, threshold);
  nusmv_assert(res);
}
...
void set_image_cluster_size(OptsHandler_ptr opt, int threshold) {
  boolean res =
      OptsHandler_set_int_option_value(opt, IMAGE_CLUSTER_SIZE, threshold);
  nusmv_assert(res);
}
...
void set_ignore_init_file(OptsHandler_ptr opt) {
  boolean res = OptsHandler_set_bool_option_value(opt, IGNORE_INIT_FILE, true);
  nusmv_assert(res);
}
void unset_ignore_init_file(OptsHandler_ptr opt) {
  boolean res = OptsHandler_set_bool_option_value(opt, IGNORE_INIT_FILE, false);
  nusmv_assert(res);
}
...
void unset_cone_of_influence(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, CONE_OF_INFLUENCE, false);
  nusmv_assert(res);
}
...
void set_prop_print_method(OptsHandler_ptr opt, const char *enum_string) {
  boolean res =
      OptsHandler_set_enum_option_value(opt, PROP_PRINT_METHOD, enum_string);
  nusmv_assert(res);
}
...
boolean set_default_trace_plugin(OptsHandler_ptr opt, int plugin) {
  return OptsHandler_set_int_option_value(opt, DEFAULT_TRACE_PLUGIN, plugin);
}
...
void set_affinity(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, AFFINITY_CLUSTERING, true);
  nusmv_assert(res);
}

void unset_affinity(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, AFFINITY_CLUSTERING, false);
  nusmv_assert(res);
}
...
void set_traces_hiding_prefix(OptsHandler_ptr opt, const char *prefix) {
  boolean res = OptsHandler_set_option_value(opt, TRACES_HIDING_PREFIX, prefix);
  nusmv_assert(res);
}
...
void set_bdd_encoding_word_bits(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, BDD_ENCODE_WORD_BITS, true);
  nusmv_assert(res);
}

void unset_bdd_encoding_word_bits(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, BDD_ENCODE_WORD_BITS, false);
  nusmv_assert(res);
}
...
void set_on_failure_script_quits(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, ON_FAILURE_SCRIPT_QUITS, true);
  nusmv_assert(res);
}

void unset_on_failure_script_quits(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, ON_FAILURE_SCRIPT_QUITS, false);
  nusmv_assert(res);
}
...
void set_write_order_dumps_bits(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, WRITE_ORDER_DUMPS_BITS, true);
  nusmv_assert(res);
}

void unset_write_order_dumps_bits(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, WRITE_ORDER_DUMPS_BITS, false);
  nusmv_assert(res);
}
...
void set_use_reachable_states(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, USE_REACHABLE_STATES, true);
  nusmv_assert(res);
}

void unset_use_reachable_states(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, USE_REACHABLE_STATES, false);
  nusmv_assert(res);
}
...
void unset_use_ansi_c_div_op(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, USE_ANSI_C_DIV_OP, false);
  nusmv_assert(res);
}
...
void set_bdd_static_order_heuristics(OptsHandler_ptr opt, BddSohEnum value) {
  ...
  boolean res =
      OptsHandler_set_enum_option_value(opt, BDD_STATIC_ORDER_HEURISTICS, val);
  nusmv_assert(res);
}
...
void unset_rbc_inlining_lazy(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, RBC_INLINING_LAZY, false);
  nusmv_assert(res);
}
...
void set_show_defines_in_traces(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, SHOW_DEFINES_IN_TRACES, true);
  nusmv_assert(res);
}

void unset_show_defines_in_traces(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, SHOW_DEFINES_IN_TRACES, false);
  nusmv_assert(res);
}
...
void set_show_defines_with_next(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, SHOW_DEFINES_WITH_NEXT, true);
  nusmv_assert(res);
}

void unset_show_defines_with_next(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, SHOW_DEFINES_WITH_NEXT, false);
  nusmv_assert(res);
}
...
void set_check_invar_strategy(OptsHandler_ptr opt, Check_Strategy strategy) {
  ...
  boolean res =
      OptsHandler_set_enum_option_value(opt, INVAR_CHECK_STRATEGY, str);
  nusmv_assert(res);
}
...
void set_check_invar_fb_heuristic(OptsHandler_ptr opt, FB_Heuristic h) {
  ...
  boolean res =
      OptsHandler_set_enum_option_value(opt, CHECK_INVAR_FB_HEURISTIC, str);
  nusmv_assert(res);
}
...
void set_check_invar_bddbmc_heuristic(OptsHandler_ptr opt,
  ...
  boolean res =
      OptsHandler_set_enum_option_value(opt, CHECK_INVAR_BDDBMC_HEURISTIC, str);
  nusmv_assert(res);
}
...
void opt_enable_daggifier(OptsHandler_ptr opt) {
  boolean res = OptsHandler_set_bool_option_value(opt, DAGGIFIER_ENABLED, true);
  nusmv_assert(res);
}

void opt_disable_daggifier(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, DAGGIFIER_ENABLED, false);
  nusmv_assert(res);
}
...
void opt_set_daggifier_counter_threshold(OptsHandler_ptr opt, int x) {
  boolean res =
      OptsHandler_set_int_option_value(opt, DAGGIFIER_COUNTER_THRESHOLD, x);
  nusmv_assert(res);
}
...
void opt_set_daggifier_depth_threshold(OptsHandler_ptr opt, int x) {
  boolean res =
      OptsHandler_set_int_option_value(opt, DAGGIFIER_DEPTH_THRESHOLD, x);
  nusmv_assert(res);
}
...
void set_daggifier_statistics(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, DAGGIFIER_STATISTICS, true);
  nusmv_assert(res);
}

void unset_daggifier_statistics(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, DAGGIFIER_STATISTICS, false);
  nusmv_assert(res);
}
...
void reset_oreg_justice_emptiness_bdd_algorithm(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_reset_option_value(opt, OREG_JUSTICE_EMPTINESS_BDD_ALGORITHM);
  nusmv_assert(res);
}
...
void set_use_coi_size_sorting(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, USE_COI_SIZE_SORTING, true);
  nusmv_assert(res);
}

void unset_use_coi_size_sorting(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, USE_COI_SIZE_SORTING, false);
  nusmv_assert(res);
}
...
void opt_disable_syntactic_checks(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, DISABLE_SYNTACTIC_CHECKS, true);
  nusmv_assert(res);
}

void opt_enable_syntactic_checks(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, DISABLE_SYNTACTIC_CHECKS, false);
  nusmv_assert(res);
}
...
void set_keep_single_value_vars(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, KEEP_SINGLE_VALUE_VARS, true);
  nusmv_assert(res);
}

void unset_keep_single_value_vars(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, KEEP_SINGLE_VALUE_VARS, false);
  nusmv_assert(res);
}
...
void reset_default_simulation_steps(OptsHandler_ptr opt) {
  boolean res = OptsHandler_reset_option_value(opt, DEFAULT_SIMULATION_STEPS);
  nusmv_assert(res);
}
...
void set_ltl2smv_single_justice(OptsHandler_ptr opt) {
  boolean res =
      OptsHandler_set_bool_option_value(opt, LTL2SMV_SINGLE_JUSTICE, true);
  nusmv_assert(res);
}
...
boolean opt_set_reachable_states_trigger(OptsHandler_ptr opts, const char *opt,
  ...
  if (ACTION_SET == action || ACTION_RESET == action) {
    ...
    boolean res =
        OptsHandler_set_bool_option_value(opts, USE_REACHABLE_STATES, enable);
    if (strcmp(opt, FORWARD_SEARCH) != 0) {
      res &= OptsHandler_set_bool_option_value(opts, FORWARD_SEARCH, enable);
    }
    nusmv_assert(res);
  }
...
boolean opt_run_cpp_trigger(OptsHandler_ptr opts, const char *opt,
  ...
  case ACTION_RESET:
    StreamMgr_print_error(
        streams, "Error: the \"%s\" option is no longer supported", RUN_CPP);
...
boolean opt_traces_regexp_trigger(OptsHandler_ptr opts, const char *opt,
  ...
  case ACTION_SET: {
    ...
    if (0 != cr) {
      ...
      StreamMgr_print_error(streams, "Error: could not parse '%s' (%s)\n",
                            value, buf);
