...
Dag_Manager_t *Dag_ManagerAlloc() {
  ...
  dagManager->vTable = st_init_table_with_params(
      DagVertexComp, DagVertexHash, DAG_DEFAULT_VERTICES_NO,
      DAG_DEFAULT_DENSITY, DAG_DEFAULT_GROWTH, 0);
